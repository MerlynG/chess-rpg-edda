...
func _ready() -> void:
	...
	for p in [[["a1"],"gk",["b3"],king_skin],[[],"",["b2"],"batn"],[[],"",["d2"],"capb"]]:
		for i in p[0]:
	...
	external_process_node.SendInput("position fen 8/8/8/8/8/1K6/1N1B4/k7 w - - 0 1")
...
func _process(_delta: float) -> void:
	...
	if !turn:
		...
		external_process_node.SendInput("position fen 8/8/8/8/8/1K6/1N1B4/k7 w - - 0 1" + moves)
