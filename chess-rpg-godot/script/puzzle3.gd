...
func _process(_delta: float) -> void:
	...
	if !turn:
		...
		match last_move:
			"b7":
				var a = enemies.get_child(3)
				a._move_to(uci_to_vect(last_move))
			"d7":
				var a = enemies.get_child(3)
				a._move_to(uci_to_vect(last_move))
			"c5":
				var a = enemies.get_child(5)
				a._move_to(uci_to_vect(last_move))
			"e5":
				var a = enemies.get_child(5)
				a._move_to(uci_to_vect(last_move))
			"a3":
				var a = enemies.get_child(2)
				a._move_to(uci_to_vect(last_move))
			"c3":
				var a = enemies.get_child(2)
				a._move_to(uci_to_vect(last_move))
			"c1":
				var a = enemies.get_child(1)
				a._move_to(uci_to_vect(last_move))
			"a1":
				var a = enemies.get_child(1)
				a._move_to(uci_to_vect(last_move))
			"e1":
				var a = enemies.get_child(4)
				a._move_to(uci_to_vect(last_move))
			"f2":
				var a = enemies.get_child(6)
				a._move_to(uci_to_vect(last_move))
			"f3":
